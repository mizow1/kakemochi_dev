						...
						<div class="in">
							<div class="box">
								...
								<ul class="new_footer_list">
									...
									<li><a href="<?php echo home_url(); ?>/founding-services/relocation/">駐在員赴任支援</a></li>
								</ul>
							</div>
							<div class="box">
							...
							<div class="box">
								...
								<ul class="new_footer_list">
									...
									<li><a href="<?php echo home_url(); ?>/webmarketing-services/influencer-marketing/">インフルエンサーマーケ</a></li>
						...
						<div class="in">
							...
							<div class="box">
								...
								<ul class="new_footer_list">
									...
									<li><a href="<?php echo home_url(); ?>/newsletter/">ニュースレター</a></li>
									<li><a href="<?php echo home_url(); ?>/seminar/overseas-expansion-to-indonesia/">ウェビナー</a></li>																		
								</ul>
							</div>
							<div class="box">
