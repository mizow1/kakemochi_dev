...
?>		
			...
			<section class="index_new_newsletter area bg02">
					<div class="inner1000">
						<div class="new_letter_box">
							...
							<div class="txt_box">
								<p class="ttl">インドネシアにおける<br class="sp">外資法人の規制緩和</p>
								<p class="txt">2025年10月2日、外国資本企業に関する最低払込資本金の要件が改正され、払込資本金が資本金の25％に引き下げられました。これにより、インドネシアで外資企業を設立する際には、これまで資本金100億ルピア（約9,200万円）が必要でしたが、25億ルピア（約2,300万円）で設立が可能となりました。この機会を逃さずに進出を検討してください。</p>
								<p class="new_btn01 right"><a href="<?php echo home_url(); ?>/founding-services/">法人設立はこちらから</a></p>
							</div>
						</div>
					</div>
			</section>
			...
			<section class="index_renew_webinar area notpbt">
				<div class="inner1000">
					<div class="box">
						<div class="txt_box">
							<p class="ttl orange">【11月5日】無料オンラインセミナー</p>
