...
$no_img_field = get_field('no_img_main_visual_img');
$mv_img = ($no_img_field && isset($no_img_field['url'])) ? $no_img_field['url'] : get_theme_file_uri().'/img/cross-border-e-commerce/visual_img.png';
if(get_the_post_thumbnail_url()){
	$mv_img = get_the_post_thumbnail_url();
}elseif($no_img_field && isset($no_img_field['url'])){
	$mv_img = $no_img_field['url'];
}else{
