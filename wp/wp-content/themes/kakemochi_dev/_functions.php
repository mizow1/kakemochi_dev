...
function article_cta_field()
{
	...
	$asign = get_post_meta($post->ID, 'article_cta', true);
	...
	$html .= '<input type="hidden" name="article_cta" id="article_cta" value="' . esc_attr($asign) . '">';
...
{
	if (isset($_POST['article_cta'])) {
		update_post_meta($post_id, 'article_cta', $_POST['article_cta']);
	}
}
